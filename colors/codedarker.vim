...
let s:cdCursorDarkDark = {'gui': '#080808', 'cterm': s:cterm01, 'cterm256': '232'}
...
let s:cdDarkGray = {'gui': '#121212', 'cterm': s:cterm00, 'cterm256': '232'}
...
call <sid>hi('LineNr', s:cdLineNumber, s:cdDarkGray, 'none', {})
